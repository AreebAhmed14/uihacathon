...
const Cart = () => {
  ...
  function increaseq(itemid:string) {
    hasData.map((items:any , key:any)=>{
      if(items.id === itemid){
  ...
  if (!value || !hasData) {
    return (
      <p className="flex justify-center items-center text-[20px] my-10 font-[700] text-[#6b5716]">
        Oops! Cart is empty
      </p>
    );
    ...
    return (
      <>
        <div className="w-full h-[55px] bg-[#FFF9E5] flex justify-around items-center max-[450px]:justify-between">
          <p className="font-[500] text-[16px] max-[450px]:text-[14px]">
            Product
          </p>
          <p className="font-[500] text-[16px] max-[450px]:text-[14px]">
            Price
        ...
        {hasData.map((value: any, item: any) => {
          return (
            <div
              key={item}
              className="w-full h-auto justify-center items-start shadow-xl my-1 flex max-[1000px]:h-auto max-[1000px]:flex-col max-[1000px]:items-center"
            >
              <div className="w-[1200px] max-[1005px]:w-[900px] max-[900px]:w-[700px]  m-2 flex flex-col justify-start items-end max-[824px]:w-[750px] max-[756px]:w-[650px] max-[650px]:w-[550px] max-[550px]:w-[450px] max-[450px]:w-[350px] max-[395px]:w-[300px]">
                <div className="w-full h-auto mt-[4rem] flex justify-start items-center max-[395px]:mt-[1.5rem]">
                  ...
                  <p className="font-[500] text-[16px] text-black ml-[18rem] flex max-[650px]:ml-[5rem] max-[550px]:ml-[4.5rem] max-[450px]:ml-[3rem]">
                    <button
                      onClick={()=>{decreaseq(value.id)}}
                    ...
                    <button
                      onClick={()=>{increaseq(value.id)}}
                      className="px-[6px] bg-green-600 text-white"
                    >
                      +
                    </button>
                  </p>
