...
const Herosame = () => {
  return (
    <>
      ...
      <div className='w-[750px] max-[1240px]:w-[750px] h-[full] mx-5 rounded-lg bg-[#FFF9E5] flex justify-center items-center max-[770px]:w-auto max-[770px]:mt-8'>
      <Image src={"/static/apisofaa2.webp"} alt='' width={950} height={950} className='overflow-hidden rounded-lg'/>
  </div>

<div className=' h-[276px] max-[830px]:h-auto ml-[4rem] flex flex-col items-center max-[1240px]:w-auto max-[580px]:mb-8 max-[770px]:ml-0 mr-10 max-[500px]:mr-0'>
