...
const page = () => {
  return (
    ...
    <div className='absolute w-full h-[450px] backdrop-blur-[3px] z-10'></div>
        ...
        <p className='text-[48px] font-[500] z-20'>My Contact</p>
    ...
    <div className='w-full flex justify-center items-center flex-col'>
        <p className='text-[36px] font-[700] mt-10'>Get In Touch With Us</p>
        <center><p className='text-[#9F9F9F] w-[645px]'>For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</p></center>

        <div className='w-[1058px] h-[923px] mt-10 flex justify-center'>
            <div className='w-[393px] h-[537px] flex flex-col justify-center'>
            ...
            <div className='w-[635px] h-[923px] items-start ml-[4rem] mt-[4rem] pl-[5rem] flex flex-col'>
    ...
    <div className='w-full h-[300px] flex justify-around items-center bg-[#FAF4F4]'>
